...
import 'package:english_application/domain/auth_models/auth_text_field.dart';
...
import 'package:english_application/presentation/pages/sign_up_page.dart';
...
//       // onPressed: () => {}
//         // Navigator.push<Widget>(context, MaterialPageRoute(builder: (context) => const SignUpPage()),
//         // )
    ...
    builder: (context, state) {
      return Padding(
          ...
          child: SignInButton(Buttons.Twitter,
              onPressed: () => context.read<LoginCubit>().signWithTwitter()));
    },
  );
}
