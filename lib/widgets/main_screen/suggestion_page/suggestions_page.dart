...
//   @override
//   FirestoreSlideshowState createState() => FirestoreSlideshowState();
// }
...
// Stream<dynamic> _queryDb({String tag = 'favourites'}) {
//   Query query = db.collection('stories').where('tags', arrayComtains: tag);
...
class _FirestoreSlideshowState extends State<FirestoreSlideshow> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget _BuildStorePage(Map<dynamic, dynamic> data) {
    return Container(
      decoration: BoxDecoration(
